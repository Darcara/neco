...
/// </remarks>
public class RelaxedPhyiscalFileProvider : IFileProvider, IDisposable {
	...
	public RelaxedPhyiscalFileProvider(String root, ExclusionFilters filters = ExclusionFilters.Sensitive) {
	...
	private Boolean IsUnderneathRoot(String fullPath) {
